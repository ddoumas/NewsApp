...
public class NewsAdapter extends ArrayAdapter<NewsItem> {
    ...
    public NewsAdapter(Context context, List<NewsItem> newsItems) {
        ...
        // Set custom typeface
        mCustomFontRegular = Typeface.createFromAsset(mContext.getAssets(), "fonts/opensans_regular.ttf");
        mCustomFontItalic = Typeface.createFromAsset(mContext.getAssets(), "fonts/opensans_italic.ttf");
    }
